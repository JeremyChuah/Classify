        ...
        <div class="container flex flex-col flex-wrap px-5 py-10 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
          <div class="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
            <a class="flex items-center justify-center font-medium text-gray-900 title-font md:justify-start">
             <Link to="/"><img src={Logo} className="w-auto h-auto" /></Link>
            </a>
            ...
            <div class="w-full px-4 lg:w-1/4 md:w-1/4 lg:text-right">
              <div class="mt-4">
                <span class="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
                  ...
                  <a class="ml-3 text-gray-500 cursor-pointer hover:text-gray-700" href="https://www.instagram.com/classify_edu/" target="_blank">
                    <svg
                      fill="none"
                      stroke="currentColor"
                      stroke-linecap="round"
